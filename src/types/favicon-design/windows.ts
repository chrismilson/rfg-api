export interface BaseWindowsFaviconDesign {
...
export interface NoChangeWindowsFaviconDesign extends BaseWindowsFaviconDesign {
    /** Use the master picture as is. */
    picture_aspect: 'no_change'
}

export interface WhiteSilhouetteWindowsFaviconDesign
    extends BaseWindowsFaviconDesign {
    /** Turn the master picture into a white silhouette. */
    picture_aspect: 'white_silhouette'
}

declare type WindowsFaviconDesign =
