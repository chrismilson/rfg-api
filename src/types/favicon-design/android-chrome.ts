export interface BaseAndroidChromeFaviconDesign {
  /**
...
export interface NoChangeAndroidChromeFaviconDesign
  extends BaseAndroidChromeFaviconDesign {
  /** Use the master picture as is. */
  picture_aspect: 'no_change'
}

export interface BackgroundAndMarginAndroidChromeFaviconDesign
  extends BaseAndroidChromeFaviconDesign {
...
export interface ShadowAndroidChromeFaviconDesign
  extends BaseAndroidChromeFaviconDesign {
  /**
 ...
 * present.
 */
declare type AndroidChromeFaviconDesign =
